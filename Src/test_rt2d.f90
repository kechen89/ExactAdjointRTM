...
!  using subroutine rt2d() where RTM with accurate adjoint implementation
!
!  Input
...
!  Usage
!
!       test_rt2d.x < in.H adj=[0/1] vel=vel.H > out.H
!
!%----------------
program zyxabc
implicit none
...
call rt2d(adj, dt,dz, nt,nz,nx, modl, data, v)
if (adj.eq.0) then
